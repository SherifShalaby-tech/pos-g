        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    !empty($settings['time_format']) ? $settings['time_format'] : null, ['class' => 'form-control
                    selectpicker', 'data-live-search' => 'true']) !!}
                </div>
                <div class="col-md-3">
                    {!! Form::label('timezone', __('lang.timezone'), []) !!}
                    {!! Form::select('timezone', $timezone_list, !empty($settings['timezone']) ? $settings['timezone'] :
                    null, ['class' => 'form-control selectpicker', 'data-live-search' => 'true']) !!}
                </div>
                <div class="col-md-3">
                    {!! Form::label('language', __('lang.language'), []) !!}
                    {!! Form::select('language', $languages, !empty($settings['language']) ? $settings['language'] :
                    null, ['class' => 'form-control selectpicker', 'data-live-search' => 'true']) !!}
                </div>
                <div class="col-md-3">
                    {!! Form::label('currency', __('lang.currency'), []) !!}
                    {!! Form::select('currency', $currencies, !empty($settings['currency']) ? $settings['currency'] :
                    null, ['class' => 'form-control selectpicker', 'data-live-search' => 'true']) !!}
                </div>
                <div class="col-md-3">
                    {!! Form::label('invoice_lang', __('lang.invoice_lang'), []) !!}
                    {!! Form::select('invoice_lang', $languages + ['ar_and_en' => 'Arabic and English'],
                    !empty($settings['invoice_lang']) ? $settings['invoice_lang'] : null, ['class' => 'form-control
                    selectpicker', 'data-live-search' => 'true']) !!}
                </div>
                <div class="col-md-3">
                    ...
                    !empty($settings['invoice_terms_and_conditions']) ? $settings['invoice_terms_and_conditions'] :
                    null, ['class' => 'form-control selectpicker', 'data-live-search' => 'true', 'placeholder' =>
                    __('lang.please_select')]) !!}
                </div>
                @if (session('system_mode') != 'restaurant')
                <div class="col-md-3">
                    {!! Form::label('default_purchase_price_percentage', __('lang.default_purchase_price_percentage'),
                ...
                <div class="col-md-3">
                    <div class="i-checks">
                        <input id="enable_tekstil" name="enable_tekstil" type="checkbox" @if
                            (!empty($settings['enable_tekstil']) && $settings['enable_tekstil']=='true' ) checked @endif
                            value="1" class="form-control-custom">
                        <label for="enable_tekstil"><strong>
                ...
                {{-- <div class="col-md-3">--}}
                    {{-- <div class="i-checks">--}}
                        ...
                        {{-- <select name="enable_tekstil" class="form-control">--}}
                            {{-- <option @if (!empty($settings['enable_tekstil']) && $settings['enable_tekstil']=='true'
                                ) selected @endif value="true">True</option>--}}
                            {{-- <option @if (!empty($settings['enable_tekstil']) &&
                                $settings['enable_tekstil']=='false' ) selected @endif value="false">False</option>--}}
                            {{-- </select>--}}
                ...
                <div class="col-md-3">
                    <div class="i-checks">
                        <input id="enable_the_table_reservation" name="enable_the_table_reservation" type="checkbox" @if
                            (!empty($settings['enable_the_table_reservation']) &&
                ...
                <div class="col-md-3">
                    ...
                    {!! Form::select('numbers_length_after_dot', ['1' => '0.0', '2' => '0.00', '3' => '0.000','4' =>
                    '0.0000', '5' => '0.00000', '6' => '0.000000', '7' => '0.0000000'],
                    !empty($settings['numbers_length_after_dot']) ? $settings['numbers_length_after_dot'] : null,
            ...
            {{-- <div class="row">--}}
                    ...
                    {{-- <div class="row">--}}
                        {{-- <div class="col-md-6">--}}
                            {{-- <div class="form-group">--}}
                                {{-- {!! Form::label('letter_header', __('lang.letter_header'), []) !!} @if
                                (!empty($settings['letter_header']))--}}
                                {{-- <button class="btn btn-xs btn-danger remove_image" data-type="letter_header">
                        ...
                        {{-- <div class="col-md-6">--}}
                            {{-- @php--}}
                            {{-- $letter_header = !empty($settings['letter_header']) ? $settings['letter_header'] :
                            null;--}}
                            {{-- @endphp--}}
                ...
                {{-- <div class="col-md-6">--}}
                    {{-- <div class="row">--}}
                        {{-- <div class="col-md-6">--}}
                            {{-- <div class="form-group">--}}
                                {{-- {!! Form::label('letter_footer', __('lang.letter_footer'), []) !!} @if
                                (!empty($settings['letter_footer']))--}}
                                {{-- <button class="btn btn-xs btn-danger remove_image" data-type="letter_footer">
                                    <i--}} {{-- class="fa fa-times"></i>
                                </button>--}}
                                {{-- @endif--}}
                                {{-- <br>--}}
                        ...
                        {{-- <div class="col-md-6">--}}
                            {{-- @php--}}
                            {{-- $letter_footer = !empty($settings['letter_footer']) ? $settings['letter_footer'] :
                            null;--}}
                            {{-- @endphp--}}
                ...
                {{-- <div class="col-md-6">--}}
                    {{-- <div class="row">--}}
                        {{-- <div class="col-md-6">--}}
                            {{-- <div class="form-group">--}}
                                {{-- {!! Form::label('logo', __('lang.logo'), []) !!} @if
                                (!empty($settings['logo']))--}}
                                {{-- <button class="btn btn-xs btn-danger remove_image" data-type="logo">
                                    <i--}} {{-- class="fa fa-times"></i>
                                </button>--}}
                                {{-- @endif--}}
                                {{-- <br>--}}
                        ...
                        {{-- <div class="col-md-6">--}}
                            ...
                            {{-- @endphp--}}
                            {{-- <img style="width: 220px; height: auto" src="{{ asset('uploads/' . $logo) }}"
                                alt="">--}}
                            {{-- </div>--}}
                        {{-- </div>--}}
                    {{-- </div>--}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        $settings['help_page_content'] : null, ['class' => 'form-control', 'id' => 'help_page_content'])
                        !!}
                    </div>
                </div>
            </div>
