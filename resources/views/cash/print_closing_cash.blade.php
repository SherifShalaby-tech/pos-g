                        ...
                        @media print {
                            ...
                            * {
                            ...
                            @page {
                                ...
                                margin: 0;
                                /* Optionally set margins for the printed page */
                            }
                        }
                    </style>
                </head>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $data['cash_register']->total_cash_in -
                                            $data['cash_register']->total_cash_out -
                                            $data['cash_register']->total_purchases -
                                            $data['cash_register']->total_expenses -
