<div class="modal-dialog add_closing_cash" role="document">
    <div class="modal-content">
        ...
        'add_closing_cash_form', 'files' => true]) !!}
                ...
                <div class="well">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            @foreach ($cr_data as $data)
                            <td>{{ $data['currency']['symbol'] }}
                                {{-- @if(($data['cash_register']->total_cash_sales -
                                $data['cash_register']->total_dining_in_cash)>0)
                                {{ @num_format($data['cash_register']->total_cash_sales -
                                $data['cash_register']->total_dining_in_cash-$total_latest_payments) }}
                                @else --}}
                                {{ @num_format($data['cash_register']->total_cash_sales -
                                $data['cash_register']->total_dining_in_cash) }}
                                {{-- @endif --}}
                            </td>
                            @endforeach
                        </tr>
                        ...
                        {{-- <tr>
                            ...
                            <td>
                                @php
                                $current_cash = $data['cash_register']->total_cash_sales +
                                $data['cash_register']->total_cash_in - $data['cash_register']->total_cash_out -
                                $data['cash_register']->total_purchases - $data['cash_register']->total_expenses -
                                $data['cash_register']->total_wages_and_compensation -
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            'placeholder' => __('lang.current_cash'), 'readonly', 'id' => 'closing_current_cash']) !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            __('lang.amount'), 'required', 'id' => 'closing_amount']) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            'user', ['class' => 'selectpicker form-control','required', 'data-live-search' => 'true',
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-default @if ($type == 'logout') close-btn-add-closing-cash @endif" @if
                ($type !='logout' ) data-dismiss="modal" @endif>@lang('lang.close')</button>
        </div>
