    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <x-page-title>
                    <h4 class="print-title">@lang('lang.internal_stock_request')</h4>
                </x-page-title>
                        ...
                        <div class="row locale_dir">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('receiver_store_id', $stores, session('user.store_id'), ['class' =>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    __('lang.declined')], 'pending', ['class' => 'selectpicker form-control',
                ...
                <div class="card mt-1 mb-0">
                    <div class="card-body py-2 px-4">
                        <div class="row locale_dir">
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('product_class_id', __('lang.product_class') , ['class'
                                    =>"locale_label mb-1"])
                                    !!}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('category_id', __('lang.category') , ['class' =>"locale_label
                                    mb-1"])
                                    !!}
                        ...
                        <div class="row locale_dir">
                            <div class="col-sm-12">
                                <button type="submit" name="submit" id="save" value="save"
                                    class="btn btn-primary pull-right btn-flat submit">@lang( 'lang.send'
                                    )</button>
