                ...
                <div class="card mt-1 mb-0">
                    <div class="card-body py-2 px-4">
                        <div class="row locale_dir">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('supplier_id', __('lang.supplier'), ['class' =>"locale_label
                                    mb-1 field_required"]) !!}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    field_required"]) !!}
                                    {!! Form::text('po_no', $po_no, ['class' => 'form-control','required',
                                    'readonly',
                                ...
                                <table class="table table-bordered table-striped table-condensed" id="product_table">
                                    <thead>
                                        <tr>
                                            ...
                                            @if(session('system_mode') == 'pos' || session('system_mode') ==
                                            'garments'
                    ...
                    <div class="card-body py-2 px-4">
                        <div class="row locale_dir">
                            <div class="col-md-12 text-center">
                                ...
                                <h3> @lang('lang.total'): <span class="final_total_span text-primary"></span>
                                </h3>
                    ...
                    <div class="card-body py-2 px-4">
                        <div class="row locale_dir">
                            <div class="col-sm-12">
                                ...
                                @endcan
                                <a href="{{action('PurchaseOrderController@create')}}" style="margin: 10px"
                                    value="cancel" class="btn btn-danger pull-right btn-flat">@lang( 'lang.cancel'
                                    )</a>
