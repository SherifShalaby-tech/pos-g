...
<section class="forms pt-2">
    <div class="container-fluid">
        <div class="col-md-12">
            ...
            <x-collapse-button color="secondary my-2 d-flex" collapse-id="PurchaseOrderFilter">
                Filter
            ...
            <x-collapse-body collapse-id="PurchaseOrderFilter">
                <form action="">
                    <div class="row">
                        <div class="col-md-3">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li>
                                        <a href="{{action('PurchaseOrderController@show', $purchase_order->id)}}?print=true"
                                            target="_blank" class=""><i class="dripicons-print btn"></i>
                                            @lang('lang.print')</a>
                                    </li>
                                    <li class="divider"></li>
                                    @endcan
