        ...
        <div class="card-body">
            <div class="col-md-12">
                <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (request()->show == 'service_provided') active @endif"
                            href="#service-provided" role="tab" data-toggle="tab">@lang('lang.service_provided')</a>
                    </li>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade @if (empty(request()->show)) show active @endif"
                        ...
                        <div class="col-md-12 text-muted">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12 ">
                                        <b>@lang('lang.name'):</b> <span class="customer_name_span">{{ $supplier->name
                                            }}</span>
                                    </div>

                                    <div class="col-md-12">
                                        <b>@lang('lang.company_name'):</b> <span class="customer_company_name_span">{{
                                            $supplier->company_name }}</span>
                                    </div>

                                    <div class="col-md-12">
                                        <b>@lang('lang.vat_number'):</b> <span class="customer_vat_number_span">{{
                                            $supplier->vat_number }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.email'):</b> <span class="customer_email_span">{{
                                            $supplier->email }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.mobile'):</b> <span class="customer_mobile_span">{{
                                            $supplier->mobile }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.address'):</b> <span class="customer_address_span">{{
                                            $supplier->address }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.city'):</b> <span class="customer_city_span">{{ $supplier->city
                                            }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.state'):</b> <span class="customer_state_span">{{
                                            $supplier->state }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.postal_code'):</b> <span class="customer_postal_code_span">{{
                                            $supplier->postal_code }}</span>
                                    </div>
                                    <div class="col-md-12">
                                        <b>@lang('lang.country'):</b> <span class="customer_country_span">{{
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ @num_format(-$add_stock->final_total) }}@else{{
                                            @num_format($add_stock->final_total) }}
                                            @endif
                                        </td>
                                        <td>
                                            @if ($add_stock->type == 'purchase_return')
                                            {{ @num_format(-$add_stock->transaction_payments->sum('amount')) }}@else{{
                    ...
                    <div role="tabpanel"
                        class="tab-pane fade @if (request()->show == 'service_provided') show active @endif"
                        id="service-provided">
                        <div class="table-responsive">
