            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => action('SupplierController@update', $supplier->id), 'id' =>
                        'supplier-form', 'method' => 'PUT', 'class' => '', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-group">
                                        ...
                                        $supplier->supplier_category_id, ['class' => 'selectpicker form-control',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('name', $supplier->name, ['class' => 'form-control', 'placeholder' =>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    $supplier->supplier_products->pluck('product_id'), ['class' => 'selectpicker
                                    form-control', 'data-live-search' => 'true', 'placeholder' =>
                                    __('lang.please_select'), 'id' => 'products', 'multiple']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::email('email', $supplier->email, ['class' => 'form-control', 'placeholder'
                                    => __('lang.email')]) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('mobile_number', $supplier->mobile_number, ['class' =>
                                    'form-control', 'placeholder' => __('lang.mobile_number')]) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('city', $supplier->city, ['class' => 'form-control', 'placeholder' =>
                                    __('lang.balance')]) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('state', $supplier->state, ['class' => 'form-control', 'placeholder'
                                    => __('lang.balance')]) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
