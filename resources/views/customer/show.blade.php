                ...
                <div class="tab-content">
                    ...
                    <div class="col-md-12 text-muted">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-md-12 ">
                                    <b>@lang('lang.name'):</b> <span class="customer_name_span">{{ $customer->name
                                        }}</span>
                                </div>

                                <div class="col-md-12">
                                    <b>@lang('lang.customer_type'):</b> <span class="customer_customer_type_span">{{
                                        $customer->customer_type->name }}</span>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <b>@lang('lang.email'):</b> <span class="customer_email_span">{{ $customer->email
                                        }}</span>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table class="table dataTable">
                            ...
                            <tbody>
                                ...
                                $total_purchase_due += $return->final_total -
                                $return->transaction_payments->sum('amount');
                                @endphp
                                @endforeach
                            </tbody>
                ...
                <div role="tabpanel" class="tab-pane fade @if (request()->show == 'sizes') show active @endif"
                    ...
                    <div class="col-md-12 mt-4 ml-2">
                        <a data-href="{{ action('CustomerSizeController@add', $customer->id) }}"
                            class="btn-modal btn btn-primary" style="color: #fff;" data-container=".view_modal"><i
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                ...
                                                <li>
                                                    ...
                                                    <a data-href="{{ action('CustomerSizeController@print', $customer_size->id) }}"
                                                        data-container=".view_modal" class="btn print-btn"><i
