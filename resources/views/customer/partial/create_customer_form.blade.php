        ...
        <div class="row locale_dir">
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('customer_type_id', __('lang.customer_type') ,['class' =>"locale_label mb-1
                    field_required"]) !!}
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('name', __('lang.name') ,['class' =>"locale_label mb-1"]) !!}
                ...
                <div class="row referred_row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('ref[0][referred_type]', ['customer' => __('lang.customer'), 'supplier' =>
                            'Supplier',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('ref[0][referred_by][]', $customers, false, ['class' => 'form-control
                            selectpicker
                            referred_by', 'data-live-search' => 'true', 'data-actions-box' => 'true', 'multiple']) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
