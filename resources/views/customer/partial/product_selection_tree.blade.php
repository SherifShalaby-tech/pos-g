...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#pctModal{{ $index }}{{ $key }}"
...
@endphp
<div class="modal fade" id="pctModal{{ $index }}{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="pctModalLabel"
    aria-hidden="true">
                                ...
                                <div class="accordion-group class_level level">
                                    <div class="row">
                                        <input id="product_class_selected{{ $class->id }}"
                                            name="pct[{{ $index }}][{{ $key }}][product_class_selected][]"
                                            type="checkbox" value="{{ $class->id }}" @if (in_array($class->id,
                                        $product_class_selected)) checked @endif
                                        class="my-new-checkbox">

                                        <div class="accordion-heading" style="width: 80%">
                                            <a class="accordion-toggle" data-toggle="collapse"
                                                data-id="{{ $index }}{{ $key }}{{ @replace_space($class->name) }}"
                                                data-parent="#{{ $index }}{{ $key }}{{ @replace_space($class->name) }}"
                                                href="#collapse{{ $index }}{{ $key }}{{ @replace_space($class->name) }}">
                                                <i
                                    ...
                                    <div id="collapse{{ $index }}{{ $key }}{{ @replace_space($class->name) }}"
                                                ...
                                                <div class="accordion-group  category_level level">
                                                    <div class="row">
                                                        <input id="category_selected{{ $category->id }}"
                                                            name="pct[{{ $index }}][{{ $key }}][category_selected][]"
                                                            type="checkbox" @if (in_array($category->id,
                                                        $category_selected)) checked @endif
                                                        value="{{ $category->id }}"
                                                        class="my-new-checkbox">
                                                        <div class="accordion-heading" style="width: 80%">
                                                            <a class="accordion-toggle" data-toggle="collapse"
                                                                data-id="{{ $index }}{{ $key }}{{ @replace_space('category_' . $category->name . '_' . $i) }}"
                                                                data-parent="#{{ $index }}{{ $key }}{{ @replace_space('category_' . $category->name . '_' . $i) }}"
                                                                href="#collapse{{ $index }}{{ $key }}{{ @replace_space('category_' . $category->name . '_' . $i) }}">
                                                                <i
                                                    ...
                                                    <div id="collapse{{ $index }}{{ $key }}{{ @replace_space('category_' . $category->name . '_' . $i) }}"
                                                        ...
                                                        <div class="accordion-inner">
                                                            ...
                                                            @include(
                                                            'product_classification_tree.partials.brand_inner_part_pst',
                                                            [
                                                            'brands' => $brands,
                                                                ...
                                                                <div class="accordion-group  sub_category_level level">
                                                                    <div class="row">
                                                                        <input
                                                                            ...
                                                                            name="pct[{{ $index }}][{{ $key }}][sub_category_selected][]"
                                                                            type="checkbox"
                                                                            value="{{ $sub_category->id }}" @if
                                                                        ...
                                                                        <div class="accordion-heading"
                                                                            ...
                                                                            <a class="accordion-toggle"
                                                                                ...
                                                                                data-id="{{ $index }}{{ $key }}{{ @replace_space('sub_category_' . $sub_category->name . '_' . $i) }}"
                                                                                data-parent="#{{ $index }}{{ $key }}{{ @replace_space('sub_category_' . $sub_category->name . '_' . $i) }}"
                                                                                href="#collapse{{ $index }}{{ $key }}{{ @replace_space('sub_category_' . $sub_category->name . '_' . $i) }}">
                                                                                <i
                                                                    ...
                                                                    <div id="collapse{{ $index }}{{ $key }}{{ @replace_space('sub_category_' . $sub_category->name . '_' . $i) }}"
                                                                        class="accordion-body collapse in">
                                                                        <div class="accordion-inner">
                                                                            @php
                                                                            $brands = null;
                                            ...
                                            <div class="row product_row">
                                                <div class="col-md-1">
                                                    <input id="product_selected{{ $product->id }}"
                                                        name="pct[{{ $index }}][{{ $key }}][product_selected][]"
                                                        type="checkbox" value="{{ $product->id }}" @if
                                                        (in_array($product->id, $product_selected)) checked @endif
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label style="color: #222;">@lang('lang.expiry'):
                                                                    ...
                                                                    {{ @format_date($expiry_date->expiry_date) }}@else{{
                                                                    'N/A' }}
                                                                    @endif
                                                                </label>
                                                            </div>
