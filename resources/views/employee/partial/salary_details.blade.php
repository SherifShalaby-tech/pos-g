        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        {!! Form::select('payment_cycle', $payment_cycle, !empty($employee->payment_cycle) ?
                        $employee->payment_cycle : null, ['class' => 'form-control salary_select selectpicker',
                        'data-live-search' => 'true', 'placeholder' => __('lang.select_payment_cycle')]) !!}
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="i-checks" style="margin-top: 40px">
                        ...
                        {!! Form::select('commission_type', $commission_type, !empty($employee->commission_type) ?
                        $employee->commission_type : null, ['class' => 'form-control salary_select selectpicker',
                        'data-live-search' => 'true', 'placeholder' => __('lang.select_commission_type')]) !!}
                        <br>
                        <br>
                        {!! Form::select('commission_calculation_period', $commission_calculation_period,
                        !empty($employee->commission_calculation_period) ? $employee->commission_calculation_period :
                        null, ['class' => 'form-control salary_select selectpicker', 'data-live-search' => 'true',
                        ...
                        !!}
                        {!! Form::select('commissioned_products[]', $products, !empty($employee->commissioned_products)
                        ? $employee->commissioned_products : null, ['class' => 'form-control salary_select
                        selectpicker', 'multiple', 'data-live-search' => 'true', 'data-actions-box' => 'true']) !!}
                        <br>
                        <br>
                        {!! Form::label('commission_customer_types', __('lang.customer_types') . ':', ['class' =>
                        'text-muted']) !!}
                        {!! Form::select('commission_customer_types[]', $customer_types,
                        !empty($employee->commission_customer_types) ? $employee->commission_customer_types : null,
                        ['class' => 'form-control salary_select selectpicker', 'multiple', 'data-live-search' => 'true',
                        'data-actions-box' => 'true']) !!}
                        <br>
                        <br>
                        {!! Form::label('commission_stores', __('lang.stores') . ':', ['class' => 'text-muted']) !!}
                        {!! Form::select('commission_stores[]', $stores, !empty($employee->commission_stores) ?
                        $employee->commission_stores : null, ['class' => 'form-control salary_select selectpicker',
                        'multiple', 'data-live-search' => 'true', 'data-actions-box' => 'true']) !!}
                        <br>
                        <br>
                        {!! Form::label('commission_cashiers', __('lang.cashiers') . ':', ['class' => 'text-muted']) !!}
                        {!! Form::select('commission_cashiers[]', $cashiers, !empty($employee->commission_cashiers) ?
                        $employee->commission_cashiers : null, ['class' => 'form-control salary_select selectpicker',
                        'multiple', 'data-live-search' => 'true', 'data-actions-box' => 'true']) !!}
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary col-md-6 px-0 m-0 rounded-0
                 text-center" data-dismiss="modal">@lang('lang.save')</button>
