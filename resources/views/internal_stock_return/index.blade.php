...
<section class="forms py-2">
    <div class="container-fluid px-2">
        <div class="col-md-12 no-print">
            ...
            <x-collapse-button color="secondary my-2 d-flex" collapse-id="InternalStockReturnListFilter">
                Filter
            ...
            <x-collapse-body collapse-id="InternalStockReturnListFilter">
                        ...
                        <table id="sales_table" class="table dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if(!empty($transfer->approved_at)) {{@format_date($transfer->approved_at)}}
                                        @endif</td>
                                    <td>@if(!empty($transfer->received_at)) {{@format_date($transfer->received_at)}}
                                        @endif</td>
