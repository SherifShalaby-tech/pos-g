        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    'id' => 'edit_stock_form', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('store_id', $stores, $add_stock->store_id, ['class' =>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('supplier_id', $suppliers, $add_stock->supplier_id, ['class' =>
                                    'selectpicker form-control', 'data-live-search' => 'true', 'required', 'style' =>
                                    'width: 80%', 'placeholder' => __('lang.please_select')]) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('po_no', $po_nos, $add_stock->purchase_order_id, ['class' =>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    => __('lang.partially_received')], $add_stock->status, ['class' => 'selectpicker
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    !empty($add_stock->paying_currency_id) ? $add_stock->paying_currency_id :
                                    App\Models\System::getProperty('currency'), ['class' => 'form-control selectpicker',
                                ...
                                <table class="table table-bordered table-striped table-condensed" id="product_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 10%" class="col-sm-4">@lang( 'lang.change_current_stock' )
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="product_row">
                                            ...
                                            <td>
                                                @if(!empty($product->variation) && $product->variation->name !=
                                                "Default")
                                                <b>{{$product->variation->name}} {{$product->sub_sku}}</b>
                                                @else
                                                {{!empty($product->product)
                                                ?$product->product->name:__('lang.deleted')}}
                                                @endif
                                                <input type="hidden"
                                            ...
                                            <td>
                                                <input type="text"
                                                    ...
                                                    min="{{!empty($product->product->units) && $product->product->units->pluck('name')[0]==("
                                                    piece"||"Piece"||"قطعة" || "قطعه" || "" )?1:0.00001}}"
                                            ...
                                            <td>
                                                <input type="text"
                                                    ...
                                                    name="add_stock_lines[{{ $loop->index }}][selling_price]" required
                                                    index_id="{{$loop->index}}"
                                            ...
                                            <td>
                                                <span class="sub_total_span">{{ number_format($product->sub_total,2)
                                                    }}</span>
                                            ...
                                            <td>
                                                ...
                                                <span class="current_stock_text">
                                                    ...
                                                    {{
                                                    number_format($current_stock,App\Models\System::getProperty('numbers_length_after_dot'))
                                                    }}@else{{ 0 }}
                                                    @endif
                                                </span>
                                            </td>
                                            <td>
                                                <div class="i-checks"><input name="stock_pricechange" id="active"
                                                        type="checkbox" class="" value="1"></div>
                                            </td>
                                            <td rowspan="2">
                                        ...
                                        <tr class="row_details_{{$loop->index}}">
                                            ...
                                            <td>
                                                {!! Form::text('add_stock_lines[' . $loop->index .
                                                '][manufacturing_date]', !empty($product->manufacturing_date) ?
                                            ...
                                            <td>
                                                ...
                                                null, ['class' => 'form-control datepicker expiry_date', 'placeholder'
                                                => __('lang.expiry_date')]) !!}
                                            </td>
                                            <td>
                                                {!! Form::text('add_stock_lines[' . $loop->index . '][expiry_warning]',
                                                $product->expiry_warning, ['class' => 'form-control
                                                days_before_the_expiry_date', 'placeholder' =>
                                                __('lang.days_before_the_expiry_date')]) !!}
                                            </td>
                                            <td>
                                                {!! Form::text('add_stock_lines[' . $loop->index .
                                                '][convert_status_expire]', $product->convert_status_expire, ['class' =>
                                                'form-control', 'placeholder' => __('lang.convert_status_expire')]) !!}
                                            </td>
                                            <td class="td_add_qty_bounce" colspan="4">
                                                ...
                                                <div class="add_qty_bounce_dive_{{$loop->index}} mt-2 hide">
                                                    ...
                                                    {!! Form::text('add_stock_lines['.$loop->index.'][bounce_qty]',
                                                    null, ['class' => 'form-control bounce_qty bounce_qty_'.$loop->index
                                                    , "index_id"=>"$loop->index"]) !!}
                                                    <label> {{__('lang.profit')}}</label>
                                                    {!! Form::text('add_stock_lines['.$loop->index.'][bounce_profit]',
                                                    null, ['class' => 'form-control
                                                    bounce_profit_'.$loop->index,'readonly']) !!}
                                                    <label> {{__('lang.new_purchase_price')}}</label>
                                                    {!!
                                                    Form::text('add_stock_lines['.$loop->index.'][bounce_purchase_price]',
                                                    null, ['class' => 'form-control
                                                    bounce_purchase_price_'.$loop->index,'readonly']) !!}
                                                </div>
                                            </td>
                                        ...
                                        <tr class="hide bounce_details_td_{{$loop->index}}">
                                            <td>
                                                ...
                                                {!!Form::text('add_stock_lines['.$loop->index.'][bounce_batch_number]',
                                                null, ['class' => 'form-control']) !!}
                                            </td>
                                            <td> {!! Form::label('', __('lang.manufacturing_date'), []) !!}<br>
                                                {!!
                                                Form::text('add_stock_lines['.$loop->index.'][bounce_manufacturing_date]',
                                                null, ['class' => 'form-control datepicker',
                                                'readonly']) !!}
                                            </td>
                                            <td> {!! Form::label('', __('lang.expiry_date'), []) !!}<br>
                                                {!! Form::text('add_stock_lines['.$loop->index.'][bounce_expiry_date]',
                                                null, ['class' => 'form-control datepicker expiry_date',
                                                'readonly']) !!}
                                            </td>
                                            <td> {!! Form::label('', __('lang.days_before_the_expiry_date'), []) !!}<br>
                                                {!!
                                                Form::text('add_stock_lines['.$loop->index.'][bounce_expiry_warning]',
                                                null, ['class' => 'form-control days_before_the_expiry_date']) !!}
                                            </td>
                                            <td> {!! Form::label('', __('lang.convert_status_expire'), []) !!}<br>
                                                {!!
                                                Form::text('add_stock_lines['.$loop->index.'][bounce_convert_status_expire]',
                                                null, ['class' => 'form-control']) !!}
                                            </td>
                                        </tr>
                        ...
                        <div class="col-md-12 text-center">
                            <h4>@lang('lang.items_count'): <span class="items_count_span" style="margin-right: 15px;">{{
                                    $add_stock->add_stock_lines->count() }}</span>
                                @lang('lang.items_quantity'): <span class="items_quantity_span"
                                    style="margin-right: 15px;">{{ $add_stock->add_stock_lines->sum('quantity')
                                    }}</span>
                            </h4>
                        </div>
                        <br>
                        <div class="col-md-12">
                            <div class="col-md-3 offset-md-8 text-right">
                                <h3> @lang('lang.total'): <span class="final_total_span">{{
                                        @num_format($add_stock->final_total) }}</span>
                                </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    => 'form-control', 'placeholder' => __('lang.other_expenses'), 'id' =>
                                    'other_expenses']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    => 'form-control', 'placeholder' => __('lang.discount'), 'id' => 'discount_amount'])
                                    !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    => 'form-control', 'placeholder' => __('lang.other_payments'), 'id' =>
                                    'other_payments']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    'store' => __('lang.store'), 'safe' => __('lang.safe')], $add_stock->source_type,
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{-- {!! Form::select('source_id', $users, $add_stock->source_id, ['class' =>
                                    'selectpicker form-control', 'data-live-search' => 'true', 'required', 'style' =>
                                    'width: 80%', 'placeholder' => __('lang.please_select'), 'id' => 'source_id',
                                    'required']) !!} --}}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    ['class' => 'form-control datepicker', 'required', 'placeholder' =>
                                    __('lang.date')]) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    'data-live-search' => 'true', 'required', 'style' => 'width: 80%','id' =>
                                    'payment_status', 'placeholder' => __('lang.please_select')]) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 payment_fields hide">
                                <div class="form-group">
                                    ...
                                    @num_format($transaction_payment->amount) : 0, ['class' => 'form-control',
                            ...
                            <div class="col-md-3 payment_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('method', $payment_type_array, !empty($transaction_payment) ?
                                    $transaction_payment->method : null, ['class' => 'selectpicker form-control',
                            ...
                            <div class="col-md-3 payment_fields hide">
                                <div class="form-group">
                                    ...
                                    => 'form-control datepicker', 'placeholder' => __('lang.payment_date')]) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 not_cash_fields hide">
                                <div class="form-group">
                                    ...
                                    $transaction_payment->ref_number : null, ['class' => 'form-control not_cash',
                            ...
                            <div class="col-md-3 not_cash_fields hide">
                                <div class="form-group">
                                    ...
                                    <br>
                                    {!! Form::text('bank_deposit_date', !empty($transaction_payment) ?
                                    @format_date($transaction_payment->bank_deposit_date) : @format_date(date('Y-m-d')),
                                    ['class' => 'form-control not_cash datepicker', 'placeholder' =>
                                    __('lang.bank_deposit_date')]) !!}
                                </div>
                            </div>
                            <div class="col-md-3 not_cash_fields hide">
                                <div class="form-group">
                                    ...
                                    $transaction_payment->bank_name : null, ['class' => 'form-control not_cash',
                            ...
                            <div
                                ...
                                <label for="due_amount" style="margin-top: 25px;">@lang('lang.due'): <span
                                        class="due_amount_span">{{ @num_format($add_stock->final_total -
                                        $add_stock->transaction_payments->sum('amount')) }}</span></label>
                            </div>
                            ...
                            <div class="col-md-3 due_fields hide">
                                <div class="form-group">
                                    ...
                                    'form-control', 'placeholder' => __('lang.notify_before_days')]) !!}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
