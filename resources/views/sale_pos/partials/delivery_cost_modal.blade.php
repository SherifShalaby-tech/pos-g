        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <select class="form-control selectpicker" name="delivery_zone_id" id="delivery_zone_id"
                                ...
                                <option @if (!empty($transaction) && $transaction->delivery_zone_id == $key) selected
                                    @endif
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <select class="form-control selectpicker" name="deliveryman_id" id="deliveryman_id"
                                ...
                                <option @if (!empty($transaction) && $transaction->deliveryman_id == $key) selected
                                    @endif
                                    value="{{ $key }}">{{ $name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="modal-footer">
                    <button type="button" name="delivery_cost_btn" class="btn btn-primary col-md-12 px-0 m-0 rounded-0
                 text-center" data-dismiss="modal">{{
