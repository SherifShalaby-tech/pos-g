                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('customer_size_id', [], !empty($transaction) ?
                            $transaction->customer_size_id : null, ['class' => 'form-control selectpicker',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('fabric_name', !empty($transaction) ? $transaction->fabric_name : null,
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('fabric_squatch', !empty($transaction) ? $transaction->fabric_squatch : null,
                            ['class' => 'form-control', 'id' => 'fabric_squatch',
                            'required'])
                            !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="prova_datetime" name="prova_datetime"
                                value="{{ !empty($transaction) ? $transaction->prova_datetime : '' }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="delivery_datetime" name="delivery_datetime"
                                value="{{ !empty($transaction) ? $transaction->delivery_datetime : '' }}"
                                value="{{date('Y-m-d\TH:i')}}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-1" style="display: flex; align-items: center;">
                            <i style="vertical-align: middle; font-size: 60px; margin: auto;"
                                class="fa fa-angle-left hide" id="size_prev"></i>
                        </div>
                        <div class="col-md-10" id="customer_size_detail_section">
                        </div>
                        <div class="col-md-1" style="display: flex; align-items: center;">
                            <i style="vertical-align: middle; font-size: 60px; margin: auto;"
                                class="fa fa-angle-right hide" id="size_next"></i>
                        </div>
                    </div>
                </div>
            </div>
