                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                ['class' => 'form-control selectpicker calculate_salary', 'data-live-search' => 'true',
                        ...
                        <div class="col-md-4 account_period">
                            <div class="form-group">
                                ...
                                'form-control', 'placeholder' => __('lang.account_period'), 'id' => 'account_period'])
                                !!}
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @format_date($wages_and_compensation->acount_period_start_date) : null, ['class'
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @format_date($wages_and_compensation->acount_period_end_date) : null, ['class'
                                        => 'form-control datepicker', 'placeholder' =>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                'placeholder' => __('lang.please_select'), 'id' => 'source_id', 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('notes', $wages_and_compensation->notes, ['class' => 'form-control',
                                'rows' => 3, 'placeholder' => __('lang.notes')]) !!}
                            </div>
                        </div>
