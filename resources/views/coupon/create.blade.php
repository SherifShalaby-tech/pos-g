            ...
            <div class="card mt-1 mb-0">
                <div class="card-body py-2 px-4">
                    <div class="row locale_dir">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-primary btn-sm refresh_code"><i
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('type', __( 'lang.type' ) ,['class' =>"locale_label mb-1
                                field_required"]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('expiry_date', __( 'lang.expiry_date' ) ,['class' =>"locale_label mb-1
                                field_required"]) !!}
