...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['url' => action('ExpenseController@update', $expense->id), 'method' =>
                    ...
                    <div class="row locale_dir">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                $expense->expense_category_id, ['class' => 'form-control selectpicker',
                                'required', 'id' => 'expense_category_id', 'placeholder' =>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                $expense->expense_beneficiary_id, ['class' => 'form-control selectpicker',
                                'data-live-search' => 'true', 'required', 'id' => 'expense_beneficiary_id',
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('store_id', $stores, $expense->store_id, ['class' =>
                                'form-control selectpicker', 'data-live-search' => 'true', 'required', 'id' =>
                                'store_id', 'placeholder' => __('lang.please_select')]) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                $expense->source_type, ['class' => 'selectpicker form-control',
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('source_id', $users, $expense->source_id, ['class' =>
                                'selectpicker form-control', 'data-live-search' => 'true', 'style' => 'width:
                                80%', 'placeholder' => __('lang.please_select'), 'id' => 'source_id',
                                'required']) !!}
                            </div>
                        </div>
                        <div class="col-md-4 hide">
                            <div class="form-group">
                                ...
                                {!! Form::text('transaction_date', !empty($expense->transaction_date) ?
                                @format_date($expense->transaction_date) : @format_date(date('Y-m-d')), ['class'
                ...
                <div class="card-body py-2 px-4">
                    <div class="row locale_dir">
                        ...
                        <div class="col-md-4 mt-4 notify_field @if (empty($expense->next_payment_date)) hide @endif">
                            <div class="i-checks">
                                <input id="notify_me" name="notify_me" type="checkbox" @if ($expense->notify_me)
                                checked @endif value="1"
                                class="form-control-custom">
                                <label class="locale_label mb-1"
                                    for="notify_me"><strong>@lang('lang.notify_me')</strong></label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="locale_label mb-1" for="details">@lang('lang.details')</label> <br>
