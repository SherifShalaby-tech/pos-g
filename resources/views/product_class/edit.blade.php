...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button id="productClass-edit-btn" class="btn btn-primary col-md-6 px-0 m-0 rounded-0
...
<script>
    $("#productClass-edit-btn").click(function (e) {
        e.preventDefault();
        getProductEditImages()
        setTimeout(() => {
