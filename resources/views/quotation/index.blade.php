...
<section class="forms pt-2">
    ...
    <div class="container-fluid no-print">
        ...
        <x-page-title>
            <h4 class="print-title">@lang('lang.quotation_list')</h4>
            <x-slot name="buttons">
        ...
        <x-collapse-button color="secondary my-2 d-flex" collapse-id="QuotationListFilter">
            Filter
        ...
        <x-collapse-body collapse-id="QuotationListFilter">
            <form action="">
                <div class="row">
                    <div class="col-md-3">
            ...
            <table id="sales_table" class="table dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if(!empty($sale->block_qty)) @lang('lang.blocked') @else @lang('lang.not_blocked')@endif
                        </td>
