                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group my-group">
                                        {!! Form::select('store_id', $stores, $sale->store_id, ['class' => 'selectpicker
                                        form-control', 'data-live-search' => 'true', 'style' => 'width: 80%', 'id' =>
                                        'store_id', 'required']) !!}
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group my-group">
                                ...
                                'selectpicker form-control', 'data-live-search' => 'true', 'style' => 'width: 80%', 'id'
                                => 'status', 'required']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group my-group">
                                {!! Form::select('terms_and_condition_id', $tac, $sale->terms_and_condition_id, ['class'
