    ...
    <div class="container-fluid no-print">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row locale_dir">
                            ...
                            <div class="col-md-3">
                                <label style="margin-top: 36px;">@lang('lang.customer_type') <span
                                        class="customer_type_name text-primary"></span></label>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="card mt-1 mb-0">
                    <div class="card-body py-2 px-4">
                        <div class="row locale_dir" style="display: none;">
                            <div class="col-md-2">
                        ...
                        <div class="row locale_dir">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('block_for_days', 1, ['class' => 'form-control',
                                    'placeholder' =>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('validity_days', null, ['class' => 'form-control',
                                    'placeholder' =>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('discount_type', __('lang.discount_type') ,['class' =>"locale_label
                                    mb-1"]) !!}
                                    {!! Form::select('discount_type', ['fixed' => 'Fixed', 'percentage' =>
                                    'Percentage'],
                                    'fixed', ['class' => 'form-control', 'data-live-search' => 'true']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('discount_value', __('lang.discount_value') ,['class'
                                    =>"locale_label mb-1"]) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    __('lang.terms_and_conditions'), ['class' =>"locale_label mb-1"]) !!}
                                    {!! Form::select('terms_and_condition_id', $tac, null, ['class' =>
                                    'selectpicker
                            ...
                            <div class="modal-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="emails" name="emails" id="emails" value="" class="form-control">
                                    </div>
                                </div>
                            </div>
