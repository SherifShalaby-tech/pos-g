...
<section class="forms pt-2">
    ...
    <div class="container-fluid">
        <div class="col-md-12 no-print">
            ...
            <x-page-title>
                <h4 class="print-title">@lang('lang.all_invoices')</h4>
            ...
            <x-collapse-button color="secondary my-2 d-flex" collapse-id="AllInvoicesListFilter">
                Filter
            ...
            <x-collapse-body collapse-id="AllInvoicesListFilter">
                <form action="">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('payment_status', $payment_status_array, request()->status, ['class' =>
                                'form-control', 'placeholder' => __('lang.all'),'data-live-search'=>"true"]) !!}
                            </div>
                        </div>
