            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        true,
                        'class' => 'pos-form', 'id' => 'sell_return_form']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 @if($sale->delivery_cost_given_to_deliveryman) d-none @endif">
                                ...
                                {!! Form::text('delivery_cost', @num_format($sell_return->delivery_cost??0), ['class' =>
                                'form-control','max'=>@num_format($sale->delivery_cost)]) !!}
                            </div>
                            <div class="@if($sale->delivery_cost_given_to_deliveryman) col-md-6 @else col-md-2 @endif">
                                {!! Form::hidden('discount_type', $sale->discount_type, ['class' => 'form-control', 'id'
                                =>
                                'discount_type']) !!}
                                {!! Form::hidden('discount_value', $sale->discount_value, ['class' => 'form-control',
                                'id'
                                => 'discount_value']) !!}
