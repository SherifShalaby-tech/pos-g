                ...
                <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {!! Form::text('start_time', null, ['class' => 'form-control time_picker filter', 'id' =>
                            'start_time']) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
...
<div class="container-fluid px-2">
    <div class="d-flex justify-content-between">
        ...
        <!-- Count item widget-->
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                <div class="icon"><i class="fa fa-cubes" style="color: #fff"></i>
                </div>
        ...
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                <div class="icon"><i class="dripicons-graph-bar" style="color: #fff"></i>
                </div>
        ...
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                <div class="icon"><i class="dripicons-return" style="color: #fff"></i>
                </div>
        ...
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                <div class="icon"><i class="dripicons-media-loop" style="color: #fff"></i>
                </div>
        ...
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                <div class="icon"><i class="dripicons-trophy" style="color: #fff"></i>
                </div>
        ...
        function getDashboardData(store_id, start_date, end_date, start_time, end_time) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $(".current_stock_value-data").html(currenct_stock_string + currenct_stock_string_p +
                        currenct_stock_string_m);
