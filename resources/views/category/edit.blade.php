...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('CategoryController@update', $category->id), 'method' => 'put', 'id' => 'category_edit_form', 'files' => true]) !!}
        ...
        <div class="modal-body">
            ...
            <div class="container mt-3">
                <div class="row mx-0"
                    ...
                    <div id="cropped_edit_category_images"></div>
                    <div class="col-10 offset-1">
        ...
        <div class="modal fade" id="editCategoryModal" tabindex="-1" role="dialog" aria-labelledby="editCategoryModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editCategoryModalLabel">Modal title</h5>
        ...
        <div class="modal-footer">
            <button id="edit-category-button" class="btn btn-primary">@lang( 'lang.update' )</button>
...
<script>
    ...
    const fileEditCategoryInput = document.querySelector('#file-input-edit');
    const previewEditCategoryContainer = document.querySelector('.preview-edit-container');
    const croppieEditCategoryModal = document.querySelector('#croppie-modal-edit');
    const croppieEditCategoryContainer = document.querySelector('#croppie-container-edit');
    const croppieEditCategoryCancelBtn = document.querySelector('#croppie-cancel-btn-edit');
    const croppieEditCategorySubmitBtn = document.querySelector('#croppie-submit-btn-edit');

    fileEditCategoryInput.addEventListener('change', () => {
        previewEditCategoryContainer.innerHTML = '';
        let files = Array.from(fileEditCategoryInput.files)
        for (let i = 0; i < files.length; i++) {
            ...
            if (FileAccept.includes(fileType)) {
                ...
                reader.addEventListener('load', () => {
                    ...
                    cropBtn.setAttribute("data-target", "#editCategoryModal")
                    ...
                    previewEditCategoryContainer.appendChild(preview);
                });
    ...
    function launchImagesCropTool(img) {
        ...
        const croppie = new Croppie(croppieEditCategoryContainer, croppieOptions);
        croppie.bind({
            url: img.src,
            orientation: 1,
        });
        ...
        croppieEditCategoryModal.style.display = 'block';

        // When the user clicks the "Cancel" button, hide the modal
        croppieEditCategoryCancelBtn.addEventListener('click', () => {
            croppieEditCategoryModal.style.display = 'none';
            $('#editCategoryModal').modal('hide');
            croppie.destroy();
        });

        // When the user clicks the "Crop" button, get the cropped image and replace the original image in the preview
        croppieEditCategorySubmitBtn.addEventListener('click', () => {
    ...
    function getImages() {
        $("#cropped_edit_category_images").empty();
        setTimeout(() => {
            ...
            for (let i = 0; i < container[0].children.length; i++) {
                ...
                $("#cropped_edit_category_images").append(newInput);
            }
            console.log(images)
            return images
        }, 300);
