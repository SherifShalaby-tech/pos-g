        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-2">
                    <div class="card-body py-1">
                        <div class="row col-12">
                            <div class="col-md-3">
                                <div class="i-checks">
                                    <input @if ($product->is_service == 1) checked @endif id="is_service"
                                    name="is_service" class="is_service" type="checkbox" value="{{$product->is_service
                                    }}"
                            ...
                            <div class="col-md-3">
                                <div class="i-checks">
                                    <input @if (isset($products_count)&& $products_count < 40)
                                    @if (!empty($product->show_at_the_main_pos_page) &&
                                    $product->show_at_the_main_pos_page=="yes") checked @endif
                                    @elseif((isset($products_count)&& $products_count == 40)) disabled @endif value="1"
                                    id="show_at_the_main_pos_page" name="show_at_the_main_pos_page"
                                    type="checkbox"
                                    class="form-control-custom">
                                    <label
                ...
                <div class="card mb-2">
                    <div class="card-body py-1">
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            <div class="col-md-4 mb-3 px-5 supplier_div @if (empty($product->is_service)) hide @endif">
                            ...
                            <div class="col-md-4 mb-3 px-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-group">
                                        ...
                                        'placeholder' => "mada"]) !!}
                                        <span class="input-group-btn">
                                            <button type="button" class="btn bg-primary btn-flat translation_btn"
                    ...
                    <x-collapse-body collapse-id="ProductsOtherDetailsFilter">
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-4 mb-3 px-5">
                                ...
                                <div class="input-group my-group">
                                    {!! Form::select('multiple_thread_colors[]', $colors,
                                    $product->multiple_thread_colors, ['class' => 'selectpicker form-control',
                                    'data-live-search' => 'true', 'disabled' => $product->type == 'variable' ? true :
                                    false, 'style' => 'width: 80%', 'multiple', 'id' => 'multiple_thread_colors']) !!}
                                    <span class="input-group-btn">
                                        @can('product_module.color.create_and_edit')
                                        <button type="button" class="btn-modal btn btn-primary btn-flat"
                                            data-href="{{ action('ColorController@create') }}?quick_add=1"
                ...
                <div
                    class="col-md-12 mb-2 px-0 d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif">
                    <x-collapse-button color="primary my-1 d-flex product-btn justify-content-end"
                        collapse-id="ProductsImageFilter">
                        @lang('lang.product_picture')
                    </x-collapse-button>

                    <x-collapse-body collapse-id="ProductsImageFilter">
                        <div
                            class="row mx-0 align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                ...
                <div
                    class="col-md-12 mb-2 px-0 d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif">
                    <x-collapse-button color="primary my-1 d-flex product-btn justify-content-end"
                        collapse-id="ProductDetailsFilter">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-md-4 mb-3 px-5">
                                <div class="i-checks">
                                    ...
                                    @endif value="1" id="automatic_consumption" name="automatic_consumption"
                                    type="checkbox"
                                    class="form-control-custom">
                                    <label
                            ...
                            <div class="col-md-4 mb-3 px-5">
                                <div class="i-checks">
                                    <input @if ($product->buy_from_supplier == 1) checked @endif id="buy_from_supplier"
                                    name="buy_from_supplier" type="checkbox" value="1"
                                    class="form-control-custom">
                                    <label
                            ...
                            <table class="table table-bordered" id="consumption_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%;">
                                            <button class="btn btn-xs btn-success add_raw_material_row" type="button"><i
                ...
                <div
                    ...
                    <x-collapse-body collapse-id="MoreInfoFilter">
                        <div class="row">
                                ...
                                <table class="table table-bordered" id="consumption_table_discount">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 5%;">
                                                <button class="btn btn-xs btn-success add_discount_row" type="button"><i
                                                        class="fa fa-plus"></i></button>
                                            </th>
                                        </tr>
                                    </thead>
                            ...
                            <div class="col-md-4 mb-3 px-5">
                                <div class="i-checks">
                                    <input @if ($product->show_to_customer) checked @endif id="show_to_customer"
                                    name="show_to_customer" type="checkbox" value="1"
                                    class="form-control-custom">
                                    <label
                ...
                <div
                    ...
                    <x-collapse-body collapse-id="DiffStoresFilter">
                        <div class="col-md-12" style="margin-top: 10px">
                            <div class="i-checks">
                                <input @if ($product->different_prices_for_stores) checked
                                @endif id="different_prices_for_stores" name="different_prices_for_stores"
                                type="checkbox"
                                value="1"
                                class="form-control-custom">
                                <label
                            ...
                            <table class="table" id="variation_table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        @if(isset($enable_tekstil) && !is_null($enable_tekstil) &&
                                        $enable_tekstil->value == "true")
                                        ...
                                        <th
                                            class="supplier_div @if(isset($product->is_service) && $product->is_service ==0) hide @endif ">
                                    ...
                                    {{-- <tr>
                                        ...
                                        <th>@lang('lang.unit')</th>
                                        <th>@lang('lang.number_vs_base_unit')</th>
                                        <th class="supplier_div @if (empty($product->is_service)) hide @endif">
                                            @lang('lang.purchase_price')</th>
                                        <th class="supplier_div @if (empty($product->is_service)) hide @endif">
                                            @lang('lang.sell_price')</th>
                                        <th>
                ...
                <div class="card mb-2">
                    <div class="card-body py-1">
                        <input type="button" id="submit-btn" value="{{ trans('lang.save') }}" class="btn btn-primary">
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
...
<script>
    var fileEditProductInput = document.querySelector('#file-input-edit-product');
