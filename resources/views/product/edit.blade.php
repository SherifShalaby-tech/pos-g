                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="i-checks">
                                    <input id="is_service" name="is_service" class="is_service" type="checkbox" @if
                                        ($product->is_service == 1) checked @endif value="{{$product->is_service }}"
                            ...
                            <div class="col-md-2">
                                <div class="i-checks">
                                    <input id="show_at_the_main_pos_page" name="show_at_the_main_pos_page"
                                        type="checkbox" @if (isset($products_count)&& $products_count < 40) @if
                                        (!empty($product->show_at_the_main_pos_page)&&
                            ...
                            <div class="col-md-4">
                                <div class="i-checks">
                                    <input id="automatic_consumption" name="automatic_consumption" type="checkbox" @if
                                        (!empty($product) && $product->automatic_consumption == 1) checked
                                    @endif value="1"
                                    class="form-control-custom">
                                    <label
                                ...
                                <table class="table table-bordered" id="consumption_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 10%;">
                                                <button class="btn btn-xs btn-success add_raw_material_row"
                            ...
                            <div class="col-md-12" style="margin-top: 10px">
                                <div class="i-checks">
                                    <input id="different_prices_for_stores" name="different_prices_for_stores" @if
                                        ($product->different_prices_for_stores) checked
                            ...
                            <div class="col-md-12" style="margin-top: 10px">
                                <div class="i-checks">
                                    <input id="this_product_have_variant" name="this_product_have_variant"
                                        type="checkbox" @if ($product->type == 'variable') checked
                                    @endif value="1"
                                    class="form-control-custom">
                                    <label
