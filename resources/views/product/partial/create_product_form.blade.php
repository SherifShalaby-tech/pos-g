...
<div class="row">
    <div class="col-md-3">
        <div class="i-checks">
            <input id="is_service" name="is_service" type="checkbox" @if (session('system_mode')=='restaurant' ) checked
    ...
    {{-- <div class="col-md-4">
        <div class="form-group supplier_div">
            ...
            <div class="input-group my-group">
                ...
                $recent_product->supplier->id : false, ['class' => 'selectpicker form-control', 'data-live-search' =>
    ...
    <div class="col-md-4 mb-2">
        ...
        <div class="input-group my-group">
            <input type="hidden" data-category_id="{{!empty($recent_product) ? $recent_product->category_id : null}}"
                id="category_value_id" />
            {!! Form::select('category_id', $categories, !empty($recent_product) ? $recent_product->category_id : false,
            ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' => 'width:
    ...
    <div class="col-md-4 mb-2">
        ...
        <div class="input-group my-group">
            {!! Form::select('brand_id', $brands, !empty($recent_product) ? $recent_product->brand_id : false, ['class'
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group my-group">
                {!! Form::text('name', null, ['class' => 'clear_input_form form-control', 'required', 'placeholder' =>
                __('lang.name')]) !!}
                <span class="input-group-btn">
    ...
    <div class="col-md-4">
        ...
        <div class="input-group my-group">
            {!! Form::select('multiple_units[]', $units, !empty($recent_product) ? $recent_product->multiple_units :
            false, ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' =>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group my-group">
            {!! Form::select('multiple_colors[]', $colors, !empty($recent_product) ? $recent_product->multiple_colors :
            false, ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' =>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group my-group">
            ...
            'data-live-search' => 'true', 'style' => 'width: 80%', 'placeholder' => __('lang.please_select'), 'id' =>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group my-group">
            {!! Form::select('multiple_sizes[]', $sizes, !empty($recent_product) ? $recent_product->multiple_sizes :
            false, ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' =>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group my-group">
            {!! Form::select('multiple_grades[]', $grades, !empty($recent_product) ? $recent_product->multiple_grades :
            false, ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' =>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group my-group">
                <select id="printers" data-live-search="true" class="selectpicker form-control" name="printers[]"
                    multiple>
    ...
    @if (session('system_mode') == 'restaurant' || session('system_mode') == 'garments' || session('system_mode') ==
    'pos')
    <div class="col-md-4">
        <div class="i-checks">
    ...
    <div class="col-md-4">
        <div class="i-checks">
            <input id="price_based_on_raw_material" class="form-control-custom" name="price_based_on_raw_material"
                type="checkbox" @if (!empty($recent_product) && $recent_product->price_based_on_raw_material == 1)
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::select('barcode_type', ['C128' => 'Code 128', 'C39' => 'Code 39', 'UPCA' => 'UPC-A', 'UPCE' =>
            'UPC-E', 'EAN8' => 'EAN-8', 'EAN13' => 'EAN-13'], !empty($recent_product) ? $recent_product->barcode_type :
    ...
    <div class="col-md-4 supplier_div">
        <div class="form-group">
            {!! Form::label('purchase_price', session('system_mode') == 'pos' || session('system_mode') == 'garments' ||
            ...
            session('system_mode') == 'garments' || session('system_mode') == 'supermarket' ? __('lang.purchase_price')
    ...
    <div class="col-md-4">
        ...
        <div class="input-group my-group">
            {!! Form::select('tax_id', $taxes, !empty($recent_product) ? $recent_product->tax_id : false, ['class' =>
            'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' => 'width: 80%',
            'placeholder' => __('lang.please_select')]) !!}
            <span class="input-group-btn">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::select('tax_method', ['inclusive' => __('lang.inclusive'), 'exclusive' => __('lang.exclusive')],
            !empty($recent_product) ? $recent_product->tax_method : false, ['class' => 'clear_input_form selectpicker
