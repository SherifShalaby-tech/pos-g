                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{
                                    number_format($add_stock->current_stock,App\Models\System::getProperty('numbers_length_after_dot'))
                                    }}</td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{
                                    number_format($stock_detial->qty_available,App\Models\System::getProperty('numbers_length_after_dot'))
                                    }}</td>
                            </tr>
                            @endforeach
                        </tbody>
