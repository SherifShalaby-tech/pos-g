        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => action('SupplierServiceController@update', $add_stock->id), 'method' =>
                    'put', 'id' => 'edit_supplier_service_form', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status', ['final' => 'Completed', 'partially_received' =>
                                    'Partially Received', 'pending' => 'Pending'], $add_stock->status, ['class' =>
                                    'selectpicker form-control', 'data-live-search' => 'true', 'required', 'style' =>
                                    'width: 80%', 'placeholder' => __('lang.please_select')]) !!}
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped table-condensed" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="sub_total_span">{{ @num_format($product->sub_total)
                                                    }}</span>
                                            ...
                                            <td>
                                                ...
                                                <span class="current_stock_text">
                                                    ...
                                                    {{ preg_match('/\.\d*[1-9]+/', (string)$current_stock) ?
                                                    $current_stock : @num_format($current_stock) }}@else{{ 0 }}
                                                    @endif
                                                </span>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="row_details_{{ $loop->index }}">
                                            ...
                                            <td>
                                                ...
                                                null, ['class' => 'form-control datepicker', 'placeholder' =>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    'store' => __('lang.store')], $add_stock->source_type, ['class' => 'selectpicker
