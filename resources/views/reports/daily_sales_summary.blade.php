                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('start_date', date('Y-m-d'), ['class' => 'form-control filter
                                    start_date']) !!}
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    'form-control selectpicker filter', 'multiple', 'id' => 'store_id',
                                    'data-actions-box' => 'true', 'placeholder' => __('lang.all'), 'data-live-search' =>
                                    'true']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
