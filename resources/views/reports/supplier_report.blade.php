...
<section class="forms pt-2">
    <div class="container-fluid">
        <div class="col-md-12  no-print">
            <x-page-title>
                <h4 class="print-title">@lang('lang.supplier_report')</h4>
            </x-page-title>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#store-return" role="tab"
                                    ...
                                    <table class="table dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>@if(!empty($add_stock->supplier)){{$add_stock->supplier->name}}@endif
                                                </td>
                                                <td>
                                                ...
                                                <td>{{@num_format($add_stock->transaction_payments->sum('amount'))}}
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{action('AddStockController@edit', $add_stock->id)}}"><i
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{action('AddStockController@edit', $payment->id)}}"><i
                                                                        class="dripicons-document-edit btn"></i>@lang('lang.edit')</a>
                                                            </li>
                                                            <li class="divider"></li>
                                                            @endcan
                                    ...
                                    <table class="table dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{@num_format($purchase_order->transaction_payments->sum('amount'))}}
                                                </td>
